...
if __name__ == '__main__':
    ...
    if branch_selection == 0:
        X_star = np.linspace(0, a_rate * l, 1001).reshape(-1, 1)
    else:
        X_star = np.linspace(a_rate * l, l, 1001).reshape(-1, 1)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('beam2_model2_a_computed_displacement_vs_position.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('beam2_model2_a_computed_Corner_vs_position.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('beam2_model2_a_computed_Curvature_vs_position.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
    ...
    plt.savefig('beam2_model2_a_training_points_high_res.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
    ...
    q = -q_fem
    if branch_selection == 0:
        X_uc = np.array([[0.0], [a_rate * l]])
        u_c = np.array([[u_fem[0]], [u_fem[-1]]])  # Ensure correct shape
        X_ac = np.array([[0.0], [a_rate * l]])
        a_c = np.array([[a_fem[0]], [a_fem[-1]]])  # Ensure correct shape
        X_kc = np.array([[0.0], [a_rate * l]])
        k_c = np.array([[-k_fem[0]], [-k_fem[-1]]])  # Ensure correct shape
    else:
        X_uc = np.array([[a_rate * l], [l]])
        u_c = np.array([[u_fem[0]], [u_fem[-1]]])  # Ensure correct shape
        X_ac = np.array([[a_rate * l], [l]])
        a_c = np.array([[a_fem[0]], [a_fem[-1]]])  # Ensure correct shape
        X_kc = np.array([[a_rate * l], [l]])
        k_c = np.array([[-k_fem[0]], [-k_fem[-1]]])  # Ensure correct shape
    ...
    plt.legend()
    plt.savefig('beam2_model2_a_generated_data_vs_PINN_high_res.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('beam2_model2_a_training_losses_high_res.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
