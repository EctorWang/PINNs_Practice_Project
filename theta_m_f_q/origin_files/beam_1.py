...
if __name__ == '__main__':
    ...
    plt.plot(x_fem, u_fem, label='FEM', linewidth=2)
    ...
    plt.plot(model.loss_log, label='Total Loss', linewidth=2)
    plt.plot(model.loss_c_log, label='Constraint Loss', linewidth=2)
    plt.plot(model.loss_f_log, label='Physics Loss', linewidth=2)
