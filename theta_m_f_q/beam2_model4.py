...
if __name__ == '__main__':
    ...
    u_fem = -q * X_star * (l**3 - 2 * l * X_star**2 + X_star**3) / (24 * EI)  # Generate displacement data
    a_fem = -q * (l**3 - 6 * l * X_star**2 + 4 * X_star**3) / (24 * EI)  # Generate corner data
    k_fem = -q * (-l * X_star + X_star**2) / (2 * EI)  # Generate curvature data
    ...
    plt.savefig('beam2_model4_training_points_high_res.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
    ...
    plt.legend()
    plt.savefig('beam2_model4_generated_data_vs_PINN_high_res.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('beam2_model4_training_losses_high_res.png', dpi=300, bbox_inches='tight')  # Save the plot
    plt.show()